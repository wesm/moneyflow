...
def category_slug(name: str) -> str:
    """Normalize a category or group name to a lowercase id slug.
...
def stable_category_id(name: str) -> str:
    ...
    CSV-imported ids persist in the per-institution database, so they carry
    a ``cat_`` prefix; equivalence with ids from other surfaces must be
    checked by comparing ``category_slug`` of the names, not the ids.
    """
