...
var readOnlyActions = []ActionDefinition{
	...
	{ActionFindDuplicates, []string{"D"}, "D", "Find duplicate transactions", "Views", ScopeAnalytical, true, false},
	...
	{ActionDeleteTransaction, []string{"x"}, "x", "Delete transaction (with confirmation)", "Actions", ScopeAnalytical, true, false},
