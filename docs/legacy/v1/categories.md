...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow categories dump              # YAML format
uvx --from 'moneyflow==0.11.1' moneyflow categories dump --format=readable  # Human-readable with counts
```
