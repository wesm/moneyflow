...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow simplefin [OPTIONS] [COMMAND]
```
...
uvx --from 'moneyflow==0.11.1' moneyflow simplefin

# Launch with a specific profile
uvx --from 'moneyflow==0.11.1' moneyflow simplefin --profile my-business

# Limit to transactions from 2025 onward
uvx --from 'moneyflow==0.11.1' moneyflow simplefin --year 2025

# Use a custom config directory
uvx --from 'moneyflow==0.11.1' moneyflow simplefin --config-dir /path/to/config
```
...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow simplefin default [OPTIONS]
```
...
uvx --from 'moneyflow==0.11.1' moneyflow simplefin default

# Set a profile as the default
uvx --from 'moneyflow==0.11.1' moneyflow simplefin default --set personal-checking

# Clear the default (forces profile selection on next launch)
uvx --from 'moneyflow==0.11.1' moneyflow simplefin default --clear
```
...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow simplefin refresh [OPTIONS]
```
...
uvx --from 'moneyflow==0.11.1' moneyflow simplefin refresh

# Hard refresh (retains local deletion tombstones)
uvx --from 'moneyflow==0.11.1' moneyflow simplefin refresh --force

# Refresh a non-default profile
uvx --from 'moneyflow==0.11.1' moneyflow simplefin refresh --profile my-business

# Refresh using a group-level profile flag
uvx --from 'moneyflow==0.11.1' moneyflow simplefin --profile my-business refresh
```
...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow simplefin status [OPTIONS]
```
...
uvx --from 'moneyflow==0.11.1' moneyflow simplefin status

# Show stats for a specific profile
uvx --from 'moneyflow==0.11.1' moneyflow simplefin status --profile my-business
```
