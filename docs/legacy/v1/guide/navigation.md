...
<em>Archived screenshot unavailable.</em>
</td>
<td width="50%">
...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow --year 2025           # Fetch from 2025-01-01 onwards
uvx --from 'moneyflow==0.11.1' moneyflow --since 2024-06-01    # Fetch from specific date onwards
uvx --from 'moneyflow==0.11.1' moneyflow --mtd                 # Fetch month-to-date only
```
