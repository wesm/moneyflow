...
the shared `~/.moneyflow` directory: it can also contain Go profiles. Prefer the reset action
above; a forgotten password cannot decrypt the old vault.
...
Credentials encrypted locally. Data only sent to Monarch Money. See [Security Documentation](https://github.com/wesm/moneyflow/blob/v0.11.1/SECURITY.md).
