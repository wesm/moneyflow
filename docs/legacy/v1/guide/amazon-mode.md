...
uvx --from 'moneyflow==0.11.1' moneyflow amazon import ~/Downloads/"Your Orders"
```
...
uvx --from 'moneyflow==0.11.1' moneyflow amazon status
```
...
uvx --from 'moneyflow==0.11.1' moneyflow amazon
```
...
```bash
# Use custom database
uvx --from 'moneyflow==0.11.1' moneyflow amazon --db-path ~/Documents/amazon-purchases.db

# All commands support --db-path
uvx --from 'moneyflow==0.11.1' moneyflow amazon --db-path ~/custom.db import ~/Downloads/"Your Orders"
uvx --from 'moneyflow==0.11.1' moneyflow amazon --db-path ~/custom.db status
```
