...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow simplefin default --set my-business
```
...
```bash
uvx --from 'moneyflow==0.11.1' moneyflow simplefin --profile personal status
uvx --from 'moneyflow==0.11.1' moneyflow simplefin refresh --profile business
```
...
See [Security Documentation](https://github.com/wesm/moneyflow/blob/v0.11.1/SECURITY.md).
