...
- Editing payee names (merchant names)
- Changing categories
- Bulk edits with multi-select
- Reviewing and committing changes

Changes sync back to YNAB immediately after commit.

**Note:** YNAB-specific behaviors:
...
- **Read/write access**: moneyflow can view and edit your YNAB data
- **No data collection**: moneyflow doesn't send data anywhere except YNAB
- **Official API**: Uses YNAB's official REST API
